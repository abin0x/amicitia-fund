...
export default function AdminReports() {
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `report-${getTitle().replace(/\s+/g, "-")}.csv`;
    a.click();
  };
  ...
  const exportPDF = async () => {
    ...
    try {
      ...
      pdf.save(`report-${getTitle().replace(/\s+/g, "-")}.pdf`);
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Generate and export investment reports</p>
      </div>
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        disabled={(date) => date < launchDate || date > now}
          ...
          <CardContent>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
              <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-4">
                ...
                <p className="text-lg font-bold mt-1">৳{report.totalCollected.toLocaleString()}</p>
              </div>
              <div className="bg-gradient-to-br from-success/10 to-success/5 rounded-xl p-4">
                ...
                <p className="text-lg font-bold mt-1">{report.totalShares}</p>
              </div>
              <div className="bg-gradient-to-br from-warning/10 to-warning/5 rounded-xl p-4">
                <p className="text-xs text-muted-foreground">Pending</p>
                <p className="text-lg font-bold mt-1">{report.totalPending}</p>
              </div>
              <div className="bg-gradient-to-br from-destructive/10 to-destructive/5 rounded-xl p-4">
                <p className="text-xs text-muted-foreground">Rejected</p>
                <p className="text-lg font-bold mt-1">{report.totalRejected}</p>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-muted/50 rounded-xl p-4">
                <p className="text-xs text-muted-foreground mb-1">Bank Transfers</p>
              ...
              <div className="bg-muted/50 rounded-xl p-4">
                <p className="text-xs text-muted-foreground mb-1">Mobile Banking</p>
